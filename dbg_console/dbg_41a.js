...
//return true; //cock blocker
  ...
  {
    // eval doboz
    var dbg_eval_style = 'z-index: 666; top: 10px; left: 10px; color: lavender; width: 304px; height: 19px; background-color: #101010; border: 1px solid darkgray; font-size: 12px; font-family: Arial, Verdna, Tahoma, serif;';
    ...
    // debug doboz
    var dbg_style = 'text-align: left; left: 10px; top: 32px; z-index: 666; width: 300px; height: 100px; margin: 0; padding: 2px; overflow: auto; font-size: 10px; background-color: black; font-family: Arial, Verdna, Tahoma, serif; border: 1px dotted darkgray; line-height: 12px; color: dimgray;';
  ...
  if(a instanceof Array || typeof(a) == 'object')
  {
    ...
    for(var i in a)
    {
      ...
      if(a[i] instanceof Array || typeof(a[i]) == 'object')
      {
        ...
        s += '<b>' + dbg_n + '.</b>&nbsp; &nbsp; <span onclick="_dbg(false, ' + c + ', ' + dbg_objects_n + ');" style="cursor: pointer; text-decoration: underline; color: ' + color + ';">[' + i + '] => ' + a[i] + '</span><br/>';
