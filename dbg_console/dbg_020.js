...
//return true; //cock blocker
  ...
  {
    // eval doboz
    var dbg_eval_style = 'z-index: 666; top: 10px; right: 10px; color: lavender; width: 340px; height: 19px; background-color: #101010; border: 1px solid darkgray; font-size: 12px; font-family: Arial, Verdna, Tahoma, serif;';
    ...
    // debug doboz
    var dbg_style = 'text-align: left; right: 10px; top: 32px; z-index: 666; width: 336px; height: 100px; margin: 0; padding: 2px; overflow: auto; font-size: 10px; background-color: black; font-family: Arial, Verdna, Tahoma, serif; border: 1px dotted darkgray; line-height: 12px; color: dimgray;';
    ...
    dbg_box.setAttribute('onmouseout', 'this.style.height = \'100px\';');
