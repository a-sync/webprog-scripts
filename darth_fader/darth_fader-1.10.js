...
{
  if (d == 1) d = "#ffffff"; //default TO color
  else d = "#ff8c00"; //default FROM color

  if (c == undefined || c == "" || c == "transparent") c = d;
  else
  {
...
function colorName_toHex (color_string)
{
  ...
  return colors[color_string.toLowerCase()];
}
